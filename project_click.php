...
<head>
    <meta charset="UTF-8">
    <link rel="stylesheet" type="text/css" href="../../style/project_click.css">
</head>
<body>
    <div class="top">
    ...
    <div class="project_photo"><img src="<?php echo $row_proj[2] ?>" style="width:517px;height:446px;border-radius:12px;"></div>
    <div class="project_title"><?php echo $row_proj[3] ?></div>
    <div class="project_term"><?php echo $row_proj[5].".".$row_proj[6].".".$row_proj[7]." ~ ".$row_proj[8].".".$row_proj[9].".".$row_proj[10] ?></div>
    <div class="project_summary_title">개요</div>
    <div class="project_summary"><?php echo $row_proj[4] ?></div>

    <div style="margin-top:620px;margin-left:210px;">
    <?php
        while($row_post = mysqli_fetch_array($data_post)){?>
            <div class="post" style="position:relative;">
                <div style="float:left;">
                    <img src="<?php echo $row_post[3]?>" class="photo">
                    <div id="prof_photo" style="margin-top:-536px;margin-left:645px;"><img src="../../assets/image/icon9.png" class="human"></div>
                        <div class="name" style="margin-top:7px;margin-left:615px;"><?php 
                            ...
                            echo $row_name[0];
                        ?></div>
                        <div class="posttime" style="margin-top:-17px;margin-left:705px;"><?php echo $row_post[4]?></div>
                        <div id="line" style="margin-top:10px; margin-left:621px;"></div>
                </div>
                    <div style="margin-top:80px; margin-left:645px;">
                        <div class="title" style="margin-top:50px;"><?php echo "[".$row_post[8]."]"?></div>
                        <div style="margin-top:-5px;"><pre class="cont" style="overflow:auto; white-space: pre-wrap;"><?php echo $row_post[5]?></pre></div>
                    ...
                    <div style="float:left;margin-left:645px;margin-top:10px;">
                        ...
                        <div style="margin-left:200px; margin-top:-20px;"><button id="btn_heart" class="heart" style="background: url('../../assets/image/icon4.png') no-repeat;"></button>
                        <p class="heart_cnt" style="margin-top:-20px;margin-left:25px;"><?php echo $row_post[7]?></p></div>
                        <div style="margin-left:250px; margin-top:-28px;"><button class="message"></button>
                        <p class="message_cnt" style="margin-top:-22px;margin-left:25px;"><?php echo $row_post[6]?></p></div>
                        <div style="margin-left:300px; margin-top:-28px;"><button id="btn_bookmark" class="bm" onclick="addBookmark()"></button></div>
                        <div id="line" style="margin-left:-25px;margin-top:5px;"></div>
                    </div>
...
<form action="write_action.php" method = "POST" name="form" enctype="multipart/form-data"> 
    ...
    $data_project1=mysqli_query($conn,$query_project1);
            ...
            <div style="text-align: center;">  
               ...
               <input type="submit" name="submit_btn" value="완료" id="complete" class="button" style="margin-top: 40px; background-color: #d8d8d8;"/>
            </div> 
